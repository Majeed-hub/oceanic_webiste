            ...
            <div className="w-full  lg:-mt-96 lg:w-2/6 px-8 py-6 ml-auto bg-blue-900 rounded-2xl">
              <div className="flex flex-col text-white">
                <div className="flex my-4 w-2/3 lg:w-3/4">
                  ...
                  <div className="flex flex-col">
                    <h2 className="text-2xl">Building Address</h2>
                    <p className="text-gray-400">Jali Road, Bhatkal - 581320</p>
                  </div>
                </div>
                ...
                <div className="flex my-4 w-2/3 lg:w-3/4">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-gray-400">Tel: +91 8971616060</p>

                    <div className="mt-5">
                      <h2 className="text-2xl">Send an E-mail</h2>
                      <p className="text-gray-400">info@oceanicbhatkal.com</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex my-4 w-2/3 lg:w-1/2">
                  <a
                    href="https://www.facebook.com/people/Oceanic-estates"
                    target="_blank"
                    rel="noreferrer"
                  ...
                  <a
                    href="https://www.linkedin.com/company/oceanic-estates"
                    target="_blank"
                    rel="noreferrer"
                    className="rounded-full flex justify-center bg-white h-8 text-blue-900  w-8  mx-1 text-center pt-1"
                  >
